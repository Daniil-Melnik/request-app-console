...
<p></p>
<p>Указанные сущности описаны в каталоге <a href="src/main/java/medan/model">src/main/java/medan/model</a>. При реализации взаимодействия была применена реализация механизма JPA - механизм Hibernate ORM. В кажом классе можно найти описание каркаса БД в виде аннотаций. Базовые дампы можно найти в <a href="request_db_init_with_index.sql">request_db_init_with_index.sql</a> и <a href="request_db_init_without_index.sql">request_db_init_without_index.sql</a>. Больше информации о конкретных методах можно найти в документационных комментариях к коду.</p>
